         ...
         <Router>
            ...
            <Switch>
               <div>
                  <Route
                     exact
                     path="/category/:choice/materials"
                     component={Materials}
                  />
                  <Route
                     exact
                     path="/category/:choice/logistics1"
                     component={Logistics1}
                  />
                  <Route
                     exact
                     path="/category/:choice/logistics2"
                     component={Logistics2}
                  />
                  <Route
                     exact
                     path="/category/:choice/fastenings"
                  ...
                  ;<Link to={'back'}>PREVIOUS QUESTION</Link>
               </div>
            </Switch>
         </Router>
      </div>
