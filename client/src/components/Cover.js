        ...
        <div>
          <div className="cover-text-container fadeIn vivify delay-500">
            <p className="cover-intro">
              Each and every one of our actions is contributing to global
              warming.
            </p>
            <p>
            ...
            <p>
              We help you to calculate the footprint of new/used/existing items,
              to make better, fairer fashion choices, whilst giving you tips to
              help reduce your fashion footprint.
            </p>
              Thank you for using the Clothing Comparison Tool.
          </div>
          ...
          {choice ? (
            ...
            <Popup
              trigger={
                <button className="buttonnext-button popIn vivify delay-2000">
                  BEGIN!
                </button>
              }
              position="top center"
